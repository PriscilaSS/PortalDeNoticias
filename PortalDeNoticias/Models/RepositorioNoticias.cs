...
{
    //class RepositorioNoticias = lista de notícias pré-definidas que vai simular uma base de dados

    //botão direito na pasta Models > add > class
    public class RepositorioNoticias
    {
        /*
        é uma lista de itens do tipo Noticia, classe definida antes
        static porque não vai precisar ser modificada, contem dados fixos
        não precisa instanciar a classe RepositorioNoticias uma vez que o atributo é static e só será listado
        */
